    ...
    export default {
        data() {
            return {
                ...
                showlook: false,
                IDENTITY: [
                    require("../../../../../static/image/onface.png"),
                    require("../../../../../static/image/orface.png"),
                    require("../../../../../static/image/Hand ID card.png"),
                    require("../../../../../static/image/Business license.png")
                ],
                FIELD: [
                    require("../../../../../static/image/Shop door.png"),
                    require("../../../../../static/image/Shop photos.png"),
                    require("../../../../../static/image/Shop photos.png")
                ],
                AGENCY: [ require("../../../../../static/image/Agency certification.png")],
                BRAND: [require("../../../../../static/image/Trademark authentication.png")]
            };
        },
        watch: {
            $route(from, to) {
        ...
        methods: {
            ...
            show() {
                ...
                img.src = require('../../../../../static/image/SketchMap.png');
                box.appendChild(img);
